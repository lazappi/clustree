...
if (seurat_present) {
    seurat_present <- packageVersion(pkg = 'Seurat') >= package_version(x = '3.0.0')
}
```

```{r seurat-not, echo = FALSE, results = 'asis', eval = !seurat_present}
cat("> **NOTE:** This section requires the Seurat package, version 3.0.0 or later",
    "This package isn't installed so the results won't be shown.")
```
...
seurat[['TSNE']] <- CreateDimReducObject(embeddings = sc_example$tsne, key = 'tSNE_')
```
